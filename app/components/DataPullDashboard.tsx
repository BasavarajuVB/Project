...
const DataPullDashboard: React.FC = () => {
  ...
  const readSuccessData = [
    { time: '3:00', success: 96.1, failure: 3.9 },
    { time: '6:00', success: 95.8, failure: 4.2 },
    { time: '9:00', success: 97.2, failure: 2.8 },
    { time: '12:00', success: 96.5, failure: 3.5 },
    { time: '15:00', success: 95.9, failure: 4.1 },
    { time: '18:00', success: 96.8, failure: 3.2 },
    { time: '21:00', success: 97.1, failure: 2.9 },
  ];
